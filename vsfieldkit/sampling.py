...
NTSC_4FSC_ACTIVE_SAMPLES = 768    # Per ST 244
NTSC_4FSC_BLANKING_SAMPLES = 142  # Per ST 244
# ST 244 starts the samples with its active region.
# It suggests 0h happens between 784 and 785, further drawing it at:
NTSC_4FSC_LEAD_BLANKING_SAMPLES = 125 + Fraction(57, 90)
NTSC_4FSC_LEAD_BLANKING_TIME = NTSC_4FSC_LEAD_BLANKING_SAMPLES / NTSC_4FSC
NTSC_ST170_ACTIVE_4FSC_SAMPLES = NTSC_ST170_LINE_ACTIVE_TIME * NTSC_4FSC
NTSC_ST170_4FSC_BLANKING_SAMPLES = NTSC_ST170_LINE_BLANKING_TIME * NTSC_4FSC
NTSC_ST170_ACTIVE_4FSC_PAD_TIME = NTSC_ST170_LINE_BLANKING_TIME
NTSC_ST170_ACTIVE_4FSC_PAD_LEAD_TIME = (
    NTSC_ST170_LEAD_BLANKING_TIME
    - NTSC_4FSC_LEAD_BLANKING_TIME
)
NTSC_ST170_ACTIVE_4FSC_PAD_LEAD_SAMPLES = (
    NTSC_ST170_ACTIVE_4FSC_PAD_LEAD_TIME
    * NTSC_4FSC
)
NTSC_ST170_ACTIVE_4FSC_PAD_TAIL_SAMPLES = (
    NTSC_4FSC_ACTIVE_SAMPLES
    - NTSC_ST170_ACTIVE_4FSC_PAD_LEAD_SAMPLES
    - NTSC_ST170_ACTIVE_4FSC_SAMPLES
)
